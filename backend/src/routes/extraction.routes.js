...
module.exports = function (app) {
    ...
    app.post('/api/files/new_extraction', [authJwt.verifyToken], extractionController.newExtraction)
    app.post('/api/files/set_extraction_number', [authJwt.verifyToken], extractionController.setExtractionNumber)
